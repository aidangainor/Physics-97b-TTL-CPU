...
;check outside loop, if we have traversed all of them, jmp to outputting the array
call &to_index_zero
pop
mov a,t
load_byte 0d
...
;if we reach here, that means we are not done sorting
push ;push once to retain existing count of how many are left
